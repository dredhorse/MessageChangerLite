...
/**
 * Contain all the Spout Server Events monitored by this plugin
 *
 * @author $Author: dredhorse$
 * @version $FullVersion$
 */
public class SpoutServerEvents implements Listener {

    private final CommonPlugin main;

    public SpoutServerEvents(CommonPlugin main) {
        this.main = main;
    }
}
